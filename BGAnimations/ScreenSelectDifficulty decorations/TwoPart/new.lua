...
local difflist = GAMESTATE:GetCurrentSong():GetStepsByStepsType('StepsType_Dance_Single');
...
local t = Def.ActorFrame{
  InitCommand=function(s) s:xy(pn==PLAYER_2 and SCREEN_RIGHT-232 or SCREEN_LEFT+232,_screen.cy) end,
