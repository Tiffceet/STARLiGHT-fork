...
t[#t+1] = Def.ActorFrame{
	...
	Def.ActorFrame{
		LoadActor("_bg")..{
			InitCommand=cmd(clearzbuffer,0;Center;zoom,8;spin;effectmagnitude,0,0,-1.5;diffuse,color("0.75,0.75,0.75,1"));
		};
	};
	Def.ActorFrame{
	InitCommand=cmd(spin;effectmagnitude,-1.5,2,-1.5;Center;zoom,0.5;);
		LoadActor("SuperNOVABG.txt")..{
			InitCommand=cmd(clearzbuffer,0;rotationx,-90;rotationz,-90;diffuse,color("1,1,1,0.75");blend,Blend.Add;zoom,8);
		};
		Def.ActorFrame{
			InitCommand=cmd(zoom,20;x,SCREEN_WIDTH/2);
			LoadActor("SuperNovaBallFog (DoubleFaced).txt")..{
				InitCommand=cmd(diffuse,color("1,1,1,0.5");blend,Blend.Add;spin;effectmagnitude,10,100,10;);
			};
			LoadActor("SuperNovaFogBall (DoubleFaced).txt")..{
				InitCommand=cmd(diffuse,color("1,1,1,0.5");blend,Blend.Add;zoom,0.9;spin;effectmagnitude,10,100,10;);
			};
			LoadActor("SuperNovaBallLine (DoubleFaced).txt")..{
				InitCommand=cmd(diffuse,color("0.8,0.8,0.8,1");blend,Blend.Add;rotationx,-200;rotationz,-90;rotationy,-60;spin;effectmagnitude,100,100,100);
			};
			LoadActor("SuperNovaBallLine (DoubleFaced).txt")..{
				InitCommand=cmd(diffuse,color("0.8,0.8,0.8,1");blend,Blend.Add;rotationx,200;rotationz,90;rotationy,60;spin;effectmagnitude,-100,-100,-100);
			};
			LoadActor("SuperNovaBall (DoubleFaced).txt")..{
				InitCommand=cmd(diffuse,color("0.6,0.6,0.6,1");blend,Blend.Add;spin;effectmagnitude,10,100,10;);
			};
		};
	};
	Def.ActorFrame{
		LoadActor("SuperNOVALine.txt")..{
			InitCommand=cmd(diffuse,color("0.4,0.4,0.4,1");blend,Blend.Add;Center;rotationx,-200;rotationz,90;rotationy,60;zoom,12;spin;effectmagnitude,100,100,100);
		};
		LoadActor("SuperNOVALine.txt")..{
			InitCommand=cmd(diffuse,color("0.4,0.4,0.4,1");blend,Blend.Add;Center;rotationx,200;rotationz,-90;rotationy,60;zoom,12;spin;effectmagnitude,-100,-100,-100);
		};
