return Def.ActorFrame{
	...
	LoadActor("header")..{
		InitCommand=function(s) s:xy(_screen.cx,SCREEN_TOP+56) end,
	};
	LoadActor("DEMONSTRATION")..{
		InitCommand=function(s) s:xy(_screen.cx,SCREEN_TOP+40):diffuseshift():effectcolor1(color("1,1,1,1")):effectcolor2(color("1,1,1,0.5")):effectperiod(2) end,
	};
	Def.ActorFrame {
		InitCommand=function(s) s:xy(_screen.cx,_screen.cy+40):draworder(45) end,
		LoadActor("titlebox");
		-- Title
		Def.BitmapText{
	...
	Def.ActorFrame{
		InitCommand=function(s) s:xy(_screen.cx,_screen.cy-210) end,
		LoadActor("_jacket back");
		Def.Sprite {
			Name="Song Jacket";
			InitCommand=function(s) s:diffusealpha(1):draworder(100) end,
