...
local t = Def.ActorFrame{
		...
		Image..{
			...
			OnCommand=function(self)
				if GAMESTATE:GetNumPlayersEnabled() > 1 then
					self:sleep(0.6):linear(0.1):diffusealpha(0.15):zoomy(0.8):linear(0.1):zoomy(1):zoomx(1.2):linear(0.1):zoomx(1)
				else
	...
	LoadActor("title small")..{
		InitCommand=cmd(diffusealpha,0;x,300;y,-120);
