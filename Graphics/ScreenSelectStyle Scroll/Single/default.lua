local Image = Def.ActorFrame{
	...
	LoadActor("pad") ..{
		InitCommand=cmd(diffusealpha,0;zoomx,1;xy,2,278);
	...
	LoadActor("Character") ..{
		InitCommand=cmd(diffusealpha,0;zoomx,1;xy,-40,10);
...
local t = Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Image..{
			...
			OnCommand=cmd(sleep,0.6;linear,0.1;diffusealpha,0.15;zoomy,0.8;linear,0.1;zoomy,1;zoomx,1.2;linear,0.1;zoomx,1);
		};
	},
	LoadActor("title small")..{
		InitCommand=cmd(diffusealpha,0;x,158;y,-120);
